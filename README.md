...
- 已完成 MVP 核心能力：默认 50+10 节奏、温和提醒、稍后、跳过、全屏静默、系统托盘、全屏休息空间、每日一景、在线内容源、本地缓存、bundled fallback 和可选环境声。
- 已完成 CI/CD：`main` push 自动构建验证与 release package artifact；`v*` tag 自动创建 GitHub Release 并上传 Windows 安装包。
...
- [内容来源与授权边界](docs/content-sources.md)
- [用户可见文案原则](docs/ux-language.md)
